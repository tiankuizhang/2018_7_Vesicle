function simulationStart(obj)
	...
	% make folder to store src,img,video etc.
		...
		%HOME = '/groups/wolg/tiankuizhang/NumericalExperiments'; % folder to save all simulation instances
		HOME = '/groups/wolg/tiankuizhang2021/NumericalExperiments'; % folder to save all simulation instances
