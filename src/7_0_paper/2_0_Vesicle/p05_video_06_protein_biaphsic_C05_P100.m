...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
simu = SD.Simulation(mfilename, 'bidomain_protein_C05_P100');
...
relaxIter = 200; KappaL = 50; Drd = 0; Pressure = 100; ConsereVol = false; NewC1 = -5; NewPressure = 100;
