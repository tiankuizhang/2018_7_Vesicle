%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
simu = SD.Simulation(mfilename, 'bicomponent80');
...
Mu = 0; correctV = 0.04; % incompressibility of vesicle
CFLNumber = 1.0;
MinimumTimeStep = 0.0;
RelativeTimeScale = 1; % relative drag coefficient for protein motion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
radius = 0.98; 
%rd = 0.98; raLd = 0.067; ra =2.0; 
...
%rd = 0.90; raLd = 0.5; ra = 2; 
rd = 0.90; raLd = 0.20; ra = 2; 
KappaL = 30; % isotropic line tension
