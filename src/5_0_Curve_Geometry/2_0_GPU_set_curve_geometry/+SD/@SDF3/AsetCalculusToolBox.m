...
function AsetCalculusToolBox(obj)
	...
	[obj.Axx,obj.Ayy,obj.Azz,obj.Axy,obj.Ayz,obj.Azx] = obj.GD3.Hessian(obj.A);
	...
	[Px,Py,Pz] = obj.GD3.Gradient(obj.AHPrimal);
	P_lap = obj.GD3.Laplacian(obj.AHPrimal);
