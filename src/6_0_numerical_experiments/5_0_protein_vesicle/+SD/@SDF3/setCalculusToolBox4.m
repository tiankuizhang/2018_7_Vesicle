...
% Heaviside function
function setCalculusToolBox4(obj)

	[obj.Fx,obj.Fy,obj.Fz] = obj.GD3.Gradient4(obj.F);
	...
	[obj.Fxx,obj.Fyy,obj.Fzz,obj.Fxy,obj.Fyz,obj.Fzx] = obj.GD3.Hessian4(obj.F);
	obj.FLaplacian = obj.GD3.Laplacian4(obj.F);
	...
	col2 = (obj.Fyz.*obj.Fzx-obj.Fxy.*obj.Fzz).*obj.Fx + ...
	...
	%% primal of Heaviside, Heaviside, DiracDelta
	obj.HPrimal = max(obj.F,0);

	[Px,Py,Pz] = obj.GD3.Gradient4(obj.HPrimal);

	P_lap = obj.GD3.Laplacian4(obj.HPrimal);
