...
function GPUInitialize(obj)
	...
	system('nvcc -ptx CUDA_Code/1_3_WENO5RK3_Reinitialization/weno5_rk3_reinitialization.cu -o CUDA_Code/1_3_WENO5RK3_Reinitialization/weno5_rk3_reinitialization.ptx');
