...
% Heaviside function
function setCalculusToolBoxWENO(obj)

	%[obj.Fx,obj.Fy,obj.Fz] = obj.GD3.Gradient(obj.F);
	[obj.Fx,obj.Fy,obj.Fz] = obj.GradientWENO(obj.F);
	...
	[obj.Fxx,obj.Fyy,obj.Fzz,obj.Fxy,obj.Fyz,obj.Fzx] = obj.HessianWENO(obj.F);
	obj.FLaplacian = obj.Fxx + obj.Fyy + obj.Fzz;
