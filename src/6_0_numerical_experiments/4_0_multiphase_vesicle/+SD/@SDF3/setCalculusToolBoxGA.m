...
function setCalculusToolBoxGA(obj,threshold)
	...
	[fx,fy,fz] = obj.GD3.Gradient(obj.F);
	kink = abs(sqrt(fx.^2+fy.^2+fz.^2) - 1.0) > threshold;
	%kink = false(obj.GD3.Size,'gpuArray');
	%kink = true(obj.GD3.Size,'gpuArray');
