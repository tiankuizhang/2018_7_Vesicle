...
function NewA = WENORK3ClosetPointSurfaceRedistance(obj,A,iter1,iter2)
	...
	for i=1:iter1
		...
		step = feval(obj.WENORK3_reinitialization_step, step, NewA, mask, deltat, ...
				...
				obj.GD3.Dx, obj.GD3.Dy, obj.GD3.Dz, obj.GD3.NumElt);	
		Atmp1 = NewA - step;
		Atmp1 = ENORK2Extend(obj,Atmp1,iter2,fxpr,fxpl,fypf,fypb,fzpu,fzpd,vx,vy,vz,fdeltat,...
		...
		step = feval(obj.WENORK3_reinitialization_step, step, Atmp1, mask, deltat, ...
				...
				obj.GD3.Dx, obj.GD3.Dy, obj.GD3.Dz, obj.GD3.NumElt);	
		Atmp2 = Atmp1 - step;
		Atmp2 = ENORK2Extend(obj,Atmp2,iter2,fxpr,fxpl,fypf,fypb,fzpu,fzpd,vx,vy,vz,fdeltat,...
				cpr,cpl,cpf,cpb,cpu,cpd);
		...
		Atmp1_5 = ENORK2Extend(obj,Atmp1_5,iter2,fxpr,fxpl,fypf,fypb,fzpu,fzpd,vx,vy,vz,fdeltat,...
				cpr,cpl,cpf,cpb,cpu,cpd);
