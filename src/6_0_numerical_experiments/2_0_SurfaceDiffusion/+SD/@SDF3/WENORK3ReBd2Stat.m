...
function NewF = WENORK3Reinitialization(obj,F,iteration)
	...
	for i=1:iteration
		...
		step = feval(obj.WENORK3_re_step_bo2, step, Fgpu, mask, deltat, ...
		...
		step = feval(obj.WENORK3_re_step_bo2, step, Ftmp1, mask, deltat, ...
				xpr, xpl, ypf, ypb, zpu, zpd, ...
		    	obj.GD3.mrows, obj.GD3.ncols, obj.GD3.lshts, ...
				obj.GD3.Dx, obj.GD3.Dy, obj.GD3.Dz, obj.GD3.NumElt);	
		Ftmp2 = Ftmp1 - step;
		...
		step = feval(obj.WENORK3_re_step_bo2, step, Ftmp0_5, mask, deltat, ...
				xpr, xpl, ypf, ypb, zpu, zpd, ...
		    	obj.GD3.mrows, obj.GD3.ncols, obj.GD3.lshts, ...
				obj.GD3.Dx, obj.GD3.Dy, obj.GD3.Dz, obj.GD3.NumElt);	
